...
public class TestaCursoComAluno {
	...
	public static void main(String[] args) {
		...
		//javaColecoes.getAlunos().add(new Aluno("Teste", 123));
		...
		System.out.println("O aluno " + aluno1 + " está matriculado? "+ javaColecoes.isAlunoMatriculado(aluno1));
